  ...
  return (
    <Routes>
      ...
      <Route path="superadmin/*" element={<SuperAdminLayout />} />
        ...
        <Route path="superadmin/subcategories/new" element={<AddNewSubCategory />} />
      <Route path="superadmin/subcategories/edit/:id" element={<EditNewSubCategory />} />
      <Route path="admin/login" element={<LoginAdmin/>} />
      <Route path="student/*" element={<StudentLayout />} />
      <Route path="student/service/:subCategoryId" element={<StudentService/>}/>
